...
### 1. Configure MCP Client (e.g. cursor) MCP Settings (Need Node.js 18+)

Add the following configuration to your MCP Client (e.g. cursor) settings:
...
### 4. Start Using in MCP Client (e.g. cursor)
